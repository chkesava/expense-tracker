...
export default function Dashboard() {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      className="min-h-screen pt-24 pb-20 px-4 md:px-8 max-w-7xl mx-auto"
    >
