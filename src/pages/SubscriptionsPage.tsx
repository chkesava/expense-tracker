...
export default function SubscriptionsPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setAmount("");
        setDay("1");
        // Ensure category reset if needed, keeping "Subscriptions" as default is good.
    };
                ...
                {isAdding && (
                    ...
                    >
                        <div className="bg-white/80 backdrop-blur-xl border border-white/60 p-6 rounded-3xl shadow-sm space-y-4">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-slate-900 text-white font-bold py-3 rounded-xl mt-2 shadow-lg hover:bg-slate-800 transition-all"
                            >
                                Save Subscription
                            </button>
                        </div>
