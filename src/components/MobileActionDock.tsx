...
export default function MobileActionDock() {
  ...
  return (
    <>
      <div className="mobile-action-dock fixed bottom-[calc(1.5rem+env(safe-area-inset-bottom))] left-0 right-0 z-[100] flex justify-center items-center gap-4 sm:gap-6 px-4 sm:px-6 md:hidden pointer-events-none transition-all duration-300">
