    ...
    <>
      <div className="mobile-action-dock fixed bottom-8 left-0 right-0 z-[100] flex justify-center items-center gap-6 px-6 md:hidden pointer-events-none transition-all duration-300">
        ...
        <motion.button
          ...
          className="w-14 h-14 rounded-3xl bg-white/90 dark:bg-slate-900/90 text-slate-900 dark:text-white flex items-center justify-center shadow-xl shadow-slate-900/10 pointer-events-auto border border-white/60 dark:border-slate-800 backdrop-blur-2xl absolute right-6"
        >
